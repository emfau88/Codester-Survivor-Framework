...
- [x] A2-Baseline-Reparatur: Support-Chick-Update-Loop sowie zwei Testisolationen nach fehlgeschlagenem `test:rooster-depth`/`test:mechanics` verifiziert (`test:rooster-depth`, `test:mechanics`, `test:evolution` grün).
